package cyoa.tests; //Change me


/**
 * Project imports
 */
import cyoa.controller.Controller; //Change me
import cyoa.view.MainPanel; //Change me
import javax.swing.*;
...
class PanelTest
{
	...
	private MainPanel testedPanel; //Change me

	@BeforeEach
	void setUp() throws Exception
	{
		this.testedController = new Controller(); //Change me
		this.testedPanel = new MainPanel(testedController); //Change me
	} 
