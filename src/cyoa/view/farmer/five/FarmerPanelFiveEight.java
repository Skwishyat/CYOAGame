...
/**
 * This is the panel for the eighth possibility of the fifth situation the user will encounter
 * It has one option for continuing the story
 * @author awil7254
 *
 */
public class FarmerPanelFiveEight extends JPanel
{	
	...
	private JButton fFourButton;
	
	/**
	 * Creates a new FarmerPanelFiveEigth with the controller it will be contained in
	 * @param app The controller that the panel will be contained in
	 */
	public FarmerPanelFiveEight(Controller app)
	{
		super();
		this.panel = new JPanel(new GridLayout(1,1));
		this.app = app;
		
		this.label = new JLabel("e8");
		this.layout = new SpringLayout();
		this.farmerInfo = new FarmerStory();
		
		this.fFourButton = new JButton("go to fourth ending");
	...
	{
		fFourButton.addActionListener(click -> app.getFrame().changeScreen(farmerInfo.panels[farmerInfo.F_FOUR]));
	}
