...
/**
 * This is the panel for the fifth possibility of the fifth situation the user will encounter 
...
public class FarmerPanelFiveFive extends JPanel
{
	...
	/**
	 * Creates a new FarmerPanelFiveFive with the controller it will be contained in
