...
/**
 * This is the panel for the first possibility of the fifth situation the user will encounter 
...
public class FarmerPanelFiveOne extends JPanel
{
	...
	/**
	 * Creates a new FarmerPanelFiveOne with the controller it will be contained in
