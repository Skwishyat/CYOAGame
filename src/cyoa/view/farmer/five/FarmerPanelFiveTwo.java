...
/**
 * This is the panel for the second possibility of the fifth situation the user will encounter
...
public class FarmerPanelFiveTwo extends JPanel
{
	...
	private JButton fOneButton;
	
	/**
	 * Creates a new FarmerPanelFiveTwo with the controller it will be contained in
	...
	public FarmerPanelFiveTwo(Controller app)
	{
		...
		this.label = new JLabel("e2");
		this.layout = new SpringLayout();
		this.farmerInfo = new FarmerStory();
		
		this.fOneButton = new JButton("go to first ending");
	...
	{
		fOneButton.addActionListener(click -> app.getFrame().changeScreen(farmerInfo.panels[farmerInfo.F_ONE]));
	}
