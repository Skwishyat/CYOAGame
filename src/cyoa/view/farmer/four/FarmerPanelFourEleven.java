...
/**
 * This is the panel for the eleventh possibility of the fourth situation the user will encounter
 * It has two options for continuing the story
 * @author awil7254
 *
 */
public class FarmerPanelFourEleven extends JPanel
{
	...
	private JButton eOneButton;
	private JButton eNineButton;
	
	/**
	 * Creates a new FarmerPanelFourEleven with the controller it will be contained in
	 * @param app The controller the panel will be contained in
	 */
	public FarmerPanelFourEleven(Controller app)
	{
		super();
		this.panel = new JPanel(new GridLayout(2,2));
		this.app = app;
		
		this.label = new JLabel("d11");
		this.layout = new SpringLayout();
		this.farmerInfo = new FarmerStory();
		
		this.eOneButton = new JButton("go to e1");
	...
	{
		eOneButton.addActionListener(click -> app.getFrame().changeScreen(farmerInfo.panels[farmerInfo.E_ONE]));
