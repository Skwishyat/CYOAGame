...
/**
 * This is the panel for the fourteenth possibility of the fourth situation the user will encounter
 * It has three options for continuing the story
 * @author awil7254
 *
 */
public class FarmerPanelFourFourteen extends JPanel
{
	...
	/**
	 * Creates a new FarmerPanelFourFourteen with the controller it will be contained in
	 * @param app The controller the panel will be contained in
	 */
	public FarmerPanelFourFourteen(Controller app)
	{
		super();
