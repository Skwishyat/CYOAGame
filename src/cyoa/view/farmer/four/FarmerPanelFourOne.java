...
/**
 * This is the panel for the first possibility of the fourth situation the user will encounter
...
public class FarmerPanelFourOne extends JPanel
{
	...
	/**
	 * Creates a new FarmerPanelFourOne with the controller it will be contained in
