...
/**
 * This is the panel for the second possibility of the fourth situation the user will encounter
...
public class FarmerPanelFourTwo extends JPanel
{
	...
	/**
	 * Creates a new FarmerPanelFourTwo with the controller it will be contained in
